// ==WindhawkMod==
// @id              valinet-explorer-hide-current-folder-name-in-search-box
// @name            Explorer: Hide current folder name in search box
// @description     Explorer: Hide current folder name in search box
// @version         1.5.7
// @author          valinet
...
{
    lpszText = L" Search";
    return CSearchBox_SetCueAndTooltipText_orig(pThis, lpszText, lpszUnused);
}
